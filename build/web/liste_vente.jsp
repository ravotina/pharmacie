          ...
          <div class="card">
            <div class="card-body">
              ...
              <!-- Formulaire pour Laboratoire -->
                 ...
                 <!-- Formulaire pour Laboratoire -->
                    <form action="<%= request.getContextPath() %>/ClientControleur" method="GET">
                         ...
                         <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                ...
                                >
                                <div id="dateError" style="color: red; display: none;">La date ne peut pas être dans le futur.</div>
                            </div>
                        </div>
