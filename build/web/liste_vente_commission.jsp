...
<% 
    ...
    List<Vente> les_vente = (List<Vente>)request.getAttribute("les_vente");
     ...
     double total_commission = (Double)request.getAttribute("total_commission");
     

   List<Sexe> les_sexe = (List<Sexe>)request.getAttribute("les_sexe"); 
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <h5 class="card-title">Produits vendu et son commission</h5>
              
              
              <!-- Formulaire pour Laboratoire -->
                    <form action="<%= request.getContextPath() %>/VenteCommissionControleur" method="GET">
                            
                                
                                
                            <div class="row mb-3">
                            <label for="selectLaboratoir" class="col-sm-2 col-form-label">Sexe</label>
                            <div class="col-sm-10">
                                <select class="form-select" id="selectLaboratoir" name="idsexe" >
                                    <option value="">Sexe</option>
                                    <!-- Options de laboratoires à remplir dynamiquement -->

                                    <% 
                                        if(les_sexe!=null){
                                            for(Sexe une_maladie : les_sexe){ %>
                           ...
                           <div class="row mb-3">
                                <label for="contact" class="col-sm-2 col-form-label">Date min</label>
                                <div class="col-sm-10">
                                    <input 
                                        type="date" 
                                        class="form-control" 
                           ...
                           <div class="row mb-3">
                                <label for="contact" class="col-sm-2 col-form-label">Date Max</label>
                                <div class="col-sm-10">
                                    <input 
                                        type="date" 
                                        class="form-control" 
              ...
              <table class="table datatable">
                <thead>
                  <tr>
                    ...
                    <th>Date vente</th>
                   <th>Client</th>
                   <th> prix  <br> moin <br> commission </th>
                    <th> type produit</th>
                    <th> Commission </th>
                  </tr>
                </thead>
                <tbody>
                 ...
                 <%
                     if(les_vente!=null){ 
                        ...
                        <td><%= une_vente.getVendeur().getNom() %></td>
                        <td><%= une_vente.getVendeur().getSexe().getNom() %></td>
                        <td><%= une_vente.getProduitDetaille().getProduit().getNom() %></td>
                        <td><%= une_vente.getDaty() %></td>
                        <td><%= une_vente.getClient().getNom() %> <%= une_vente.getClient().getPrenom() %></td>
                        <td> <%= une_vente.getPrix() %> </td>
                        <td><%= une_vente.getProduitDetaille().getProduit().getTypeProduit().getNom() %></td>
                        <td><%= une_vente.getCommission() %></td>
